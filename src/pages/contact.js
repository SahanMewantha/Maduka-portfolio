    ...
    <>
        ...
        <main className='flex-col items-center justify-center w-full mt-4 sm:flex dark:text-light'>
            ...
            <div class="grid grid-cols-3 mt-10 sm:grid-cols-1"> 
              <div class='xs:flex sm:flex h-52 text-center  text-md text-dark rounded-xl w-72 opacity-75  bg-zinc-400 dark:text-light box-shadow shadow-2xl  hover:shadow-green-600 sm:h-28 sm:w-full sm:mb-5'>
              
                  <WhatsAppIcon className={' h-1/5 w-1/5 mx-28 mt-6 sm:h-1/2 sm:w-1/2 sm:ml-1 xs:h-1/2 xs:w-1/2' }/>
                  <div className='sm:mr-36 xs:text-sm xs:mr-10'>
              ...
              <div class='xs:flex sm:flex h-52 text-center text-md text-dark rounded-xl w-72 opacity-75 bg-zinc-400 dark:text-light box-shadow shadow-2xl hover:shadow-orange-600 sm:h-28 sm:w-full sm:mb-5'>
                
                  <TelephoneIcon className={'h-1/5 w-1/5 mx-28 mt-6 sm:h-1/2 sm:w-1/2 sm:ml-2 sm:align-sub xs:h-1/2 xs:w-1/2'}/>
              ...
              <div class='xs:flex sm:flex h-52 text-center bg-zinc-400 text-md text-dark rounded-xl w-72 opacity-75 dark:text-light box-shadow shadow-2xl hover:shadow-red-600 sm:h-28 sm:w-full sm:mb-5'>
              <MailIcon className={'h-1/5 w-1/5 mx-28 mt-6 sm:h-1/2 sm:w-1/2 sm:ml-0 '}/>
                <div className='sm:mr-40 xs:text-sm xs:mr-10'>
